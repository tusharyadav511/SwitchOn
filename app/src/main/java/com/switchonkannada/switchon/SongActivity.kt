...
class SongActivity : AppCompatActivity() , Player.EventListener {
    ...
    private val mHidePart2Runnable = Runnable {
        ...
        fullscreen_song.systemUiVisibility =
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fullscreen_song.setOnClickListener { toggle() }
        supportActionBar?.hide()

        videoUrl = intent.getStringExtra("song_url")
        url = Uri.parse(videoUrl)


        window.statusBarColor = ContextCompat.getColor(this, R.color.black)
        songView = findViewById(R.id.song_view)
        backButton = findViewById(R.id.songBackButton)
        mVisible = true
        ...
        songView.setControllerVisibilityListener { visibility ->
            when (visibility) {
                View.GONE -> {
    ...
    private fun inExoPlayer(){
        ...
        try {
            ...
            songView.player = simpleExoPlayer
